      ...
      <div className="px-4 pb-8 pt-12 text-center md:px-6 md:pb-10 md:pt-16">
        <span className="inline-flex h-12 w-12 items-center justify-center">
          <svg width="38" height="38" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            <rect x="3" y="3" width="18" height="18" rx="5" stroke="var(--color-ink)" strokeWidth="1.5" />
            <circle cx="12" cy="12" r="4" stroke="var(--color-ink)" strokeWidth="1.5" />
            <circle cx="17.5" cy="6.5" r="1.2" fill="var(--color-ink)" />
          </svg>
        </span>
        <h2
