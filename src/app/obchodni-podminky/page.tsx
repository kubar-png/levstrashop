...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-20">
      ...
      <h1 className="mt-2 text-5xl font-medium">Obchodní podmínky</h1>
      ...
      <article className="mt-10 space-y-8 text-neutral-800">
        ...
        <section>
          <h2 className="text-2xl font-medium">2. Objednávka a uzavření smlouvy</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-medium">3. Doprava a platba</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-medium">4. Odstoupení od smlouvy</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-medium">5. Reklamace</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-medium">6. Mimosoudní řešení sporů</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-2xl font-medium">7. Závěrečná ustanovení</h2>
          <p className="mt-2">
