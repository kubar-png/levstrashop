...
export const mockProducts: ProductView[] = [
  // ── KUFRY ────────────────────────────────────────────────────────────
  {
    ...
    colorHex: '#e07a3a',
    variants: [
      { sku: 'RIGA-OR-55', size: 'cabin-55', color: 'oranžová', colorHex: '#e07a3a', priceCents: 279000, stock: 8, weightGrams: 2800 },
      { sku: 'RIGA-OR-65', size: 'medium-65', color: 'oranžová', colorHex: '#e07a3a', priceCents: 349000, stock: 5, weightGrams: 3400 },
      { sku: 'RIGA-OR-75', size: 'large-75', color: 'oranžová', colorHex: '#e07a3a', priceCents: 419000, stock: 3, weightGrams: 4100 },
    ],
    featured: true,
  },
  {
    ...
    colorHex: '#e2a3b0',
    variants: [
      { sku: 'RIGA-PK-55', size: 'cabin-55', color: 'růžová', colorHex: '#e2a3b0', priceCents: 279000, stock: 6, weightGrams: 2800 },
      { sku: 'RIGA-PK-65', size: 'medium-65', color: 'růžová', colorHex: '#e2a3b0', priceCents: 349000, stock: 4, weightGrams: 3400 },
      { sku: 'RIGA-PK-75', size: 'large-75', color: 'růžová', colorHex: '#e2a3b0', priceCents: 419000, stock: 2, weightGrams: 4100 },
    ],
    featured: true,
  },
  {
    ...
    category: { title: 'Kufry', slug: 'kufry' },
    subcategory: 'k-odbaveni',
    colorGroup: 'riga',
    colorHex: '#f0c742',
    variants: [
      { sku: 'RIGA-YL-55', size: 'cabin-55', color: 'žlutá', colorHex: '#f0c742', priceCents: 279000, stock: 5, weightGrams: 2800 },
      { sku: 'RIGA-YL-65', size: 'medium-65', color: 'žlutá', colorHex: '#f0c742', priceCents: 349000, stock: 4, weightGrams: 3400 },
    ],
    featured: false,
  },
  {
    ...
    colorHex: '#26344d',
    variants: [
      { sku: 'RIGA-NV-55', size: 'cabin-55', color: 'tmavě modrá', colorHex: '#26344d', priceCents: 279000, stock: 10, weightGrams: 2800 },
      { sku: 'RIGA-NV-65', size: 'medium-65', color: 'tmavě modrá', colorHex: '#26344d', priceCents: 349000, stock: 7, weightGrams: 3400 },
      { sku: 'RIGA-NV-75', size: 'large-75', color: 'tmavě modrá', colorHex: '#26344d', priceCents: 419000, stock: 4, weightGrams: 4100 },
    ],
    featured: false,
  },
  ...
  // ── KABELKY ──────────────────────────────────────────────────────────
  {
    ...
    shortDescription: 'Elegantní kabelka z pravé italské kůže.',
    ...
    colorHex: '#1c1c1c',
    variants: [
      { sku: 'NIKOL-BK', color: 'černá', colorHex: '#1c1c1c', size: 'one-size', priceCents: 229000, stock: 12, weightGrams: 850 },
      { sku: 'NIKOL-BG', color: 'béžová', colorHex: '#d4b896', size: 'one-size', priceCents: 229000, stock: 8, weightGrams: 850 },
      { sku: 'NIKOL-BR', color: 'hnědá', colorHex: '#7a4e35', size: 'one-size', priceCents: 229000, stock: 6, weightGrams: 850 },
    ],
    featured: true,
  },
  {
    ...
    shortDescription: 'Měkká hobo kabelka z pravé kůže s minimalistickým designem.',
    descriptionText: KABELKA_DESC,
    ...
    colorHex: '#1c1c1c',
    variants: [
      { sku: 'SOFIA-BK', color: 'černá', colorHex: '#1c1c1c', size: 'one-size', priceCents: 249000, stock: 10, weightGrams: 900 },
      { sku: 'SOFIA-CR', color: 'krémová', colorHex: '#f5ecd7', size: 'one-size', priceCents: 249000, stock: 7, weightGrams: 900 },
    ],
    featured: true,
  },
  {
    ...
    shortDescription: 'Strukturovaná satchel kabelka z eko-kůže pro denní nošení.',
    descriptionText: KABELKA_DESC,
    imageUrls: [IMG.modelPink],
    placeholder: { kind: 'handbag', color: '#5a3a2a', accent: '#e0b888' },
    category: { title: 'Kabelky', slug: 'kabelky' },
    subcategory: 'kozenkove',
    colorHex: '#1c1c1c',
    variants: [
      { sku: 'ELENA-BK', color: 'černá', colorHex: '#1c1c1c', size: 'one-size', priceCents: 269000, stock: 9, weightGrams: 1100 },
      { sku: 'ELENA-CO', color: 'koňaková', colorHex: '#8b6445', size: 'one-size', priceCents: 269000, stock: 5, weightGrams: 1100 },
    ],
    featured: false,
  },
  {
    ...
    shortDescription: 'Malá crossbody kabelka z eko-kůže — doplněk pro každý den.',
    descriptionText: KABELKA_DESC,
    ...
    colorHex: '#1c1c1c',
    variants: [
      { sku: 'LARA-BK', color: 'černá', colorHex: '#1c1c1c', size: 'one-size', priceCents: 189000, stock: 15, weightGrams: 480 },
      { sku: 'LARA-WH', color: 'bílá', colorHex: '#f0eeeb', size: 'one-size', priceCents: 189000, stock: 8, weightGrams: 480 },
    ],
    featured: true,
  },
];
...
export const mockSummaries: ProductSummaryView[] = mockProducts.map((p) => ({
  ...
  colorHex: p.colorHex,
  variantColorHexes: Array.from(new Set(p.variants.map((v) => v.colorHex).filter((h): h is string => !!h))),
}));
