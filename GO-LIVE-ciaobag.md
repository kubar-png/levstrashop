...
- **Patička**: DIČ, věta „Provozovatelem e-shopu ciaobag.cz je Levstra s.r.o." + backlink na www.levstra.cz, kontakt info@ciaobag.cz.
...
- **GDPR**: ciaobag.cz, zpracovatelé (ComGate / PPL / Resend / Ecomail), info@ciaobag.cz, odstraněn „VZOR".
- **Vrácení + Kontakt**: kontaktní e-mail info@ciaobag.cz.
- **E-mailové šablony, OG obrázek, výchozí base-URL** (sitemap / robots / canonical / metadataBase) → ciaobag.cz.
- **Rozhodnutí**: kontaktní/odesílací e-mail = **info@ciaobag.cz** (nutno zřídit schránku + ověřit doménu v Resendu — sekce 5). Backlink = www.levstra.cz. Sociální profily zatím @levstra (beze změny).

**Zbývá ručně (dashboardy, mimo kód):** doména + DNS ve Vercelu (1), produkční env vč. `NEXT_PUBLIC_SITE_URL` a `COMGATE_TEST=0` (2), URL v Comgate portálu (3), ostré PPL údaje (4), Resend doména + schránka info@ciaobag.cz (5), Sanity webhook + CORS (6), Search Console (7).
...
| E-mail | info@levstra.cz *(viz rozhodnutí níže — případně info@ciaobag.cz)* |
...
- kontaktní e-mail dle rozhodnutí (info@levstra.cz / info@ciaobag.cz)
...
1. **Kontaktní/odesílací e-mail**: nechat `info@levstra.cz` (funguje hned), nebo zřídit a používat `info@ciaobag.cz`?
